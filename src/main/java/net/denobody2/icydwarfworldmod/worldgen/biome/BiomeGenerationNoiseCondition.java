...
public class BiomeGenerationNoiseCondition {
    ...
    private final int idwmRarityOffset;
    ...
    private BiomeGenerationNoiseCondition(boolean disabledCompletely, int distanceFromSpawn, int idwmRarityOffset, float[] continentalness, float[] erosion, float[] humidity, float[] temperature, float[] weirdness, float[] depth, String[] dimensions) {
        ...
        this.depth = depth;
        this.idwmRarityOffset = idwmRarityOffset;
    ...
    public boolean test(EventReplaceBiome event) {
        ...
        Vec3 rareBiomeCenter = ModBiomeRarity.getRareBiomeCenterQuad(event.getWorldSeed(), idwmRarityOffset, event.getX(), event.getZ());
    ...
    public static final class Builder {
        ...
        public Builder idwmRarityOffset(int rarityOffset) {
