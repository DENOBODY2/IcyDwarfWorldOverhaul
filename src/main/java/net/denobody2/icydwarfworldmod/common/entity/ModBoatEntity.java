...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        switch (getModVariant()) {
            case MANDARIN -> {
                return ModItems.MANDARIN_BOAT.get();
            }
        }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.MANDARIN.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        MANDARIN(ModBlocks.MANDARIN_PLANKS.get(), "mandarin");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, MANDARIN);
        }
    }
}
